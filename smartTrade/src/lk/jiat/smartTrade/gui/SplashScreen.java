        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                for (int i = 0; i <= 100; i++) {
                    ...
                    if (i < 30) {
                        jLabel1.setText("Starting model: " + i + "%");
                    } else if (i > 30 && i < 80) {
                        jLabel1.setText(" Database connection estabalish:" + i + "%");
                    } else if (i > 80) {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jProgressBar2, javax.swing.GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE))
